...
class UsersTask
{
     ...
     * @return UsersTask
     */
    public function setCoTaskStatus(\TaskBundle\Entity\Task_Status $coTaskStatus)
    {
     ...
     * Set mainTask
     *
     * @param \TaskBundle\Entity\Task $mainTask
     * @return UsersTask
     */
    public function setMainTask(\TaskBundle\Entity\Task $mainTask)
    {
